...
public class Management implements IManagement{
    ...
    public Management(String fileName) throws IOException {
        ...
        System.out.println("Anzahl der Grundoperationen: " + numberNormalOperations);
    }
   ...
   /**
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            management.members(Department.SALES);
            int c = 0;
            for(Department d : Department.values()) {

                management.members(d);
                c+=management.getNumberOfNormalOperations();
            }
