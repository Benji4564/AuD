...
public class LargeTestA2 {
	...
	private String msgNoOp    = "Anzahl der Operationen enspricht nicht den erwarteten.";
	 ...
	 *			<li>Anzahl Operationen: 130.000 &plusmn; 10.000.</li>
	 *		</ul> 
	 *	</li>
	 * </ul>
	 * @throws IOException 
	 ...
	 *			<li>toArray() liefert ein Array der Groesse 10.000.</li>
	 *			<li>Die gespeicherten Daten entsprechen den uebergebenen Datensaetzen.</li>
	 *			<li>Anzahl Operationen: 70.000 &plusmn; 5.000.</li>
	 *		</ul> 
	 *	</li>
	 * </ul>
	 * @throws IOException 
	...
	public void testSortiertesEinfuegen() throws IOException {
		testEmployee();
		...
		evaluate(mgnt.numberOfOperations(), 70000, 5000);
	}
	 ...
	 *				gefunden werden.</li>
	 *			<li>Gesamtanzahl Operationen beim Suchen 13 &plusmn; 2.</li>
	 *		</ul> 
	 *	</li>
	 * </ul>
	 * @throws IOException 
	...
	public void testSucheNamen() throws IOException {
		...
		assertFalse("Fehlerhafte / fehlende Datensaetze in der Mitarbeiterverwaltung.",
				trace.hasOccurrences());
		evaluate(mgnt.numberOfOperations(), 20, 8);
	}
	 ...
	 * 		</ul>
	 * 	</li>
	 * 	<li>Erwartete Gesamtanzahl Operationen beim Suchen aller 10.000 Eintraege: 
	 *	    240 &plusmn; 20.	
	 * 	</li>
	 * </ul>
	 * @throws IOException 
	...
	public void testDepartment() throws IOException {
		...
		trace.add(PassTrace.ifEquals("Anzahl Mitglieder in der Abteilung %s: %d", 
				789, got.length, Department.SERVICE, 789));		
		evaluate(expData.where((c, it) -> "Service".equals(it.getPart(6))), true, got);
		trace.add("Aufruf von numberOfOperations().");
		evaluate(mgnt.numberOfOperations(), 28, 4);
	}
